...
export default function AdminSubscriptionRequestsScreen() {
        ...
        <View style={styles.actionsRow}>
          ...
          {isPending && (
            <TouchableOpacity
              ...
              onPress={() => handleCheckAndOpenCompleteModal(item)}
              disabled={isCheckingMeters}
            >
              {isCheckingMeters ? (
  ...
  return (
    <View style={styles.container}>
      ...
      />
      {/* ==================== د. نافذة تأكيد التعيين كمكتمل مع عرض العدادات ==================== */}
      <Modal
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>تأكيد تعيين الطلب كمكتمل</Text>
            <Text style={styles.pwdLabel}>
              المشترك ({requestToComplete?.fullName}) صاحب هذا الطلب يمتلك
              العدادات المسندة التالية في النظام:
            </Text>

            <View style={styles.boundMetersListBox}>
              {userBoundMeters.map((m, idx) => (
                <Text key={`bound-${idx}`} style={styles.boundMeterItemText}>
                  ⚡ {m.alias} (ID: {m.meterId.substring(0, 18)}...)
                </Text>
              ))}
            </View>

            <Text style={styles.confirmPromptText}>
              هل تؤكد أن هذا الطلب يتبع لأحد هذه العدادات وتستكمل تعيين الطلب
              كمكتمل؟
            </Text>
            ...
            <View style={styles.modalActions}>
              ...
              >
                <Text style={styles.modalBtnText}>نعم، تأكيد التعيين</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.modalBtn,
                ...
                onPress={() => setIsCompleteConfirmVisible(false)}
              >
                <Text
